                   ...
                   @foreach($day_of_week as $day)
                      @if($day == $time->day)
                        <td>
                          ...
                          <b>Teacher:</b> {{ $time->teacher ? $time->teacher->name : '' }}<br>
                          @if( $time->class && $time->course )
                            <a href="{{ url('/students') }}?class={{ $time->class->id }}&course={{ $time->course->id }}" class="badge badge-primary">View Students</a>
                          @endif
                        </td>
                      @else
                        <td></td>
