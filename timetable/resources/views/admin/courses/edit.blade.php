...
<div class="content-wrapper">
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <div class="card-title"><i class="fa fa-user-circle-o"></i> Update courses</div>
        <hr>
        ...
        {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="course_code" value="{{$course->course_code}}" class="form-control" placeholder="Course Code">
              </div>
            </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="course_name" value="{{$course->course_name}}" class="form-control form-control-square"  placeholder="Course Name">
              </div>
            </div>
          ...
          <div class="form-group">
            <div class="form-footer">
              <a href="{{ url('courses') }}" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</a>
